    ...
    <div className='flex flex-col'>
      <div className='flex flex-col gap-8'>
        <div className='flex items-center justify-between'>
          <div className='text-2xl font-semibold'>Trending Events around the world</div>
...
const EventCard = () => {
  return (
    <div className='h-[390px] w-[380px] rounded-xl shadow-md overflow-hidden flex flex-col mx-auto'>
